...
{
	showOnErrorDialogInfomation errorInfomation;

	errorInfomation.messageShowForUser = "画像の読み込みに失敗しました。\n"
		"以下の項目を確認してください。\n"
		"* resourceフォルダの位置を変更していないか\n"
		"* resourceフォルダの中に画像ファイルが全て存在するか";
	errorInfomation.developerTwitterAddress = "https://twitter.com/terapotan";
	errorInfomation.developerMailAddress = "gameblog60@gmail.com";
	errorInfomation.exceptionTypeName = "imageLoadFailureException";
	errorInfomation.exceptionDetail = "ball.pngの読み込みに失敗しました。";
	errorInfomation.exceptionOccurPlaceFile = "playDisplayImageManagement.cpp";
	errorInfomation.exceptionOccurPlaceLine = 10;

	errorInfomation.nowRunSoftwareName = "BreakingBlocks";
	errorInfomation.nowRunsoftwareVersion = "prealpha5.1";
	errorInfomation.useOS = "Windows10";
	errorInfomation.dxLibraryVersion = "3.02f";
	errorInfomation.messageShowForDeveloper = "* exeファイルの2階層上の1階層下にresourceフォルダが存在すること\n"
		"* パスの区切り字が間違っていないこと\n"
		"* 読み込み失敗したファイルが存在すること、破損していないこと"
		"を確認してください。";

	this->showErrorDialog(errorInfomation);
}
